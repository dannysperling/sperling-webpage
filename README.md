# Danny Sperling Homepage

This project is a work in progress to create a homepage with react. React is not the correct tool for this job, but rather used as an opportunity to learn and practice react.
